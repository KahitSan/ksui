// Source: KahitSan/kserp src/components/PayeePicker.tsx (vendored into the plugin remote).
//
// Cross-plugin picker for the "Paid to" / "Received from" / "Payable to" field.
...
// trigger usable, and the transactions API persists payee as a plain string
// regardless, so the modal still saves.
