...
export default function ClientPickerPage(): JSX.Element {
  return (
    <article>
      <h1>Client Picker</h1>
      <p class="lead">
        A cross plugin picker that searches the sibling clients plugin at <code>/api/clients</code>. It degrades
        gracefully: when the clients plugin is not deployed the popup shows an inline notice and the rest of the form
        keeps working.
      </p>
      ...
      <Example
        ...
        description="On this docs site the /api/clients fetch is not reachable, so the popup shows its graceful fallback notice. That is the intended offline behavior."
