...
// SonarJS recommended (at error). e2e/ is excluded so the suite stays an
// untouched behavior regression check. This plugin ships an oversized UI
...
// is enforced.
export default [
  { ignores: ["node_modules/**", "dist*/**", ".vinxi/**", "e2e/**", "**/*.config.*", "**/*.d.ts"] },
